...
* Thiết lập thành công môi trường auto-scaling với ALB.
* Host static website sử dụng Amazon S3.
* Hiểu được sự khác biệt về kiến trúc và use case cho EBS, EFS và S3.
