...
* Thiết kế và triển khai một mạng VPC tuỳ chỉnh, bảo mật.
* Triển khai và kết nối thành công tới RDS instance trong mạng nội bộ.
* Có kinh nghiệm thực tế truy vấn các bảng DynamoDB.
