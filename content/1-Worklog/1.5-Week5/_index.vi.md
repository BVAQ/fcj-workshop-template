...
* Hoàn thành thiết lập hạ tầng nền tảng với sự cô lập mạng phù hợp.
* Thiết lập thành công kết nối giữa các tài nguyên tính toán và cơ sở dữ liệu.
* Áp dụng nguyên tắc đặc quyền tối thiểu (least privilege) sử dụng IAM roles.
