...
| Phần con | Mô tả |
|---|---|
| [5.7.1 CloudWatch Dashboards](5.7.1-cloudwatch-dashboards/) | Các bảng theo dõi metric của Raft, bộ nhớ EFS, mức sử dụng CPU/RAM, và tình trạng của Load Balancer |
| [5.7.2 CloudWatch Alarms](5.7.2-cloudwatch-alarms/) | Tự động báo động khi CPU/RAM quá tải, lỗi lưu dữ liệu, deploy thất bại, hoặc container bị ngưng hoạt động |
| [5.7.3 Health Check Container & Ứng dụng](5.7.3-health-checks/) | Đảm bảo container luôn khoẻ mạnh bằng các lệnh kiểm tra của ECS và ALB, kèm theo quy tắc khởi động |
| [5.7.4 Centralized Logging](5.7.4-centralized-logging/) | Gom nhóm và lưu trữ mọi log vào CloudWatch để dễ dàng tìm kiếm khi cần debug |
