...
|---|---|
| [5.8.1 Resource Removal Policy Design](5.8.1-removal-policy-design/) | How we decide whether to RETAIN or DESTROY resources like ECR, EFS, S3, and Secrets Manager |
| [5.8.2 Stack Destruction Procedures](5.8.2-stack-destruction/) | Step-by-step guides for tearing down staging and production stacks, plus tips for CI/CD cleanup |
| [5.8.3 Retained Data Cleanup](5.8.3-retained-data-cleanup/) | The manual steps we use to safely delete retained data, old S3 versions, and leftover EFS files |
