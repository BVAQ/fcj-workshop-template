...
|---|---|
| [5.6.1 CDK Infrastructure Testing](5.6.1-cdk-infrastructure-testing/) | We use Jest to generate real CloudFormation templates and make sure our infrastructure matches what we expect |
| [5.6.2 Application Testing](5.6.2-application-testing/) | Unit tests for our Go code, plus integration tests for PostgreSQL and our DynamoDB/S3 setup |
| [5.6.3 CI/CD Pipeline Validation](5.6.3-ci-cd-pipeline-validation/) | Our GitHub Actions and GitLab CI workflows that automatically check every deployment |
