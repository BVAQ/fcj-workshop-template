...
| Phần con | Mô tả |
|---|---|
| [5.6.1 Kiểm thử Hạ tầng CDK](5.6.1-cdk-infrastructure-testing/) | Dùng Jest để tạo ra các template CloudFormation thực tế và đảm bảo hạ tầng được cấu hình chuẩn xác |
| [5.6.2 Kiểm thử Ứng dụng](5.6.2-application-testing/) | Unit test cho code Go, kết hợp với integration test cho PostgreSQL và MiniStack (DynamoDB + S3) |
| [5.6.3 Xác thực Pipeline CI/CD](5.6.3-ci-cd-pipeline-validation/) | Các luồng GitHub Actions và GitLab CI tự động kiểm tra code trước mỗi lần deploy |
