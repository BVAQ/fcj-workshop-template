...
RaftDB images are always referenced by **immutable SHA256 digest** in the ECS task definition (see [5.4.4 ECS Compute](5.4.4-ecs-compute/)). This is enforced at two levels:
