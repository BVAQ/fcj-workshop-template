...
| Phần con | Mô tả |
|---|---|
| [5.4.1 Điểm vào & Kết hợp Stack](5.4.1-entry-point/) | File chính kết nối tất cả các module lại với nhau theo đúng thứ tự (Bao gồm: CDK App, AwsplaceStack, RaftDbStagingStack) |
| [5.4.2 VPC & Mạng](5.4.2-vpc-networking/) | Thiết lập mạng dùng public subnets và không dùng NAT Gateway để tiết kiệm chi phí (Bao gồm: VPC, subnets, security groups) |
| [5.4.3 Lớp Cơ sở dữ liệu DynamoDB](5.4.3-database-dynamodb/) | Thiết kế single-table đơn giản với khóa kết hợp (Bao gồm: 4 bảng DynamoDB TableV2 dạng on-demand) |
| [5.4.4 Lớp Tính toán ECS Fargate](5.4.4-ecs-compute/) | Nơi chạy ứng dụng Go và RaftDB đằng sau HTTPS load balancer (Bao gồm: Fargate cluster, task definitions, ALB) |
| [5.4.5 Lưu trữ: ECR & S3](5.4.5-storage-ecr/) | Nơi lưu Docker image và các file của ứng dụng (Bao gồm: ECR repository, 2 bucket S3 được import vào) |
| [5.4.6 IAM Roles & Bảo mật](5.4.6-iam-security/) | Phân quyền vừa đủ (least-privilege) cho các container và Lambda (Bao gồm: 3 IAM roles) |
| [5.4.7 Lambda, API Gateway & Amplify](5.4.7-lambda-apigw-amplify/) | Chứa các hàm xử lý xác thực và chỗ host frontend (Bao gồm: Lambda, HTTP API v2, Amplify app) |
| [5.4.8 Cơ sở hạ tầng RaftDB & Route 53](5.4.8-raftdb-route53/) | Cấu hình DNS, chứng chỉ bảo mật và môi trường staging cho RaftDB (Bao gồm: Route 53, ACM cert, staging stack) |
