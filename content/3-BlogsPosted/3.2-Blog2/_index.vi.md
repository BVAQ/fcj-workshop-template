...
<figure>
  <img src="/images/3-BlogPosted/iam-oidc.png" alt="Console IAM của AWS hiển thị OpenID Connect identity provider git.namanhishere.com với duy nhất một audience được đăng ký" loading="lazy">
...
<figure>
  <img src="/images/3-BlogPosted/gitlab-oidc-trust.svg" alt="Sơ đồ tuần tự mô tả một job GitLab CI đổi token OIDC đã ký lấy credential AWS tạm thời qua IAM và STS" loading="lazy">
...
<figure>
  <img src="/images/3-BlogPosted/gitlab-ci.png" alt="Pipeline #73 của GitLab ở chế độ job dependencies, hiển thị mười bốn job trải trên các stage build-ci-image, test, build và deploy" loading="lazy">
...
<figure>
  <img src="/images/3-BlogPosted/cicd-pipeline.svg" alt="Bốn stage của pipeline GitLab awsplace với chuỗi giám hộ image RaftDB được làm nổi bật" loading="lazy">
...
---
**Link bài viết gốc trên cộng đồng AWS Study Group:** [Tại đây](https://www.facebook.com/groups/awsstudygroupfcj/permalink/2227894604642166/#)
