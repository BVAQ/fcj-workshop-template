...
<figure>
  <img src="/images/3-BlogPosted/longqueue.png" alt="Danh sách job GitLab có thời gian chờ từ 11 đến 33 phút" loading="lazy">
...
<figure>
  <img src="/images/3-BlogPosted/gitlab-runner-ec2-autoscale-vi.svg" alt="Sơ đồ GitLab Runner Manager điều khiển EC2 Auto Scaling Group và các worker tạm thời" loading="lazy">
...
<figure>
  <img src="/images/3-BlogPosted/ghcr.png" alt="Docker image của GitLab Runner worker được publish trên GitHub Container Registry" loading="lazy">
...
<figure>
  <img src="/images/3-BlogPosted/build_image.png" alt="Log Packer pull Docker image và hoàn tất tạo Amazon Machine Image" loading="lazy">
...
<figure>
  <img src="/images/3-BlogPosted/runner.png" alt="GitLab Runner sử dụng Docker Autoscaler đang online và xử lý các job" loading="lazy">
...
---
**Link bài viết gốc trên cộng đồng AWS Study Group:** [Tại đây](https://www.facebook.com/groups/awsstudygroupfcj/permalink/2225051181593175/#)
